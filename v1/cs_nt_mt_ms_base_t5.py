...
def get_model():
    ...
    cs_encoder_output = encoder_layer(cs_encoder_input)

    ms_decoder_output = decoder_layer(ms_decoder_input, ms_encoder_output)
    nt_decoder_output = decoder_layer(nt_decoder_input, nt_decoder_input, gpt_mode=True)
    cs_decoder_output = decoder_layer(cs_decoder_input, cs_encoder_output)
    ...
    y_cs = tf.keras.layers.Dense(vocab_size, name="cs_output")(cs_decoder_output)
...
model.compile(
    loss={"ms_output": masked_loss, "mt_output": masked_loss, "nt_output": masked_loss, "cs_output": masked_loss},
    optimizer=optimizer,
